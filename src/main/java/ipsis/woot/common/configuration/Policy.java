...
public class Policy {
    ...
    public static Policy get() { return INSTANCE; }
    ...
    public void loadFromConfig() {
        customPolicy.clear();
        Config.COMMON.CAPTURE_BLACKLIST_FULL_MOD.get().forEach(s -> customPolicy.addToCaptureMod(s));
        Config.COMMON.CAPTURE_BLACKLIST_ENTITY.get().forEach(s -> customPolicy.addToCaptureEntity(s));
        Config.COMMON.LEARN_BLACKLIST_FULL_MOD.get().forEach(s -> customPolicy.addToLearnMod(s));
        Config.COMMON.LEARN_BLACKLIST_ITEM.get().forEach(s -> customPolicy.addToLearnItem(s));
        Config.COMMON.GENERATE_BLACKLIST_FULL_MOD.get().forEach(s -> customPolicy.addToGenerateMod(s));
        Config.COMMON.GENERATE_BLACKLIST_ITEM.get().forEach(s -> customPolicy.addToGenerateItem(s));
    }
