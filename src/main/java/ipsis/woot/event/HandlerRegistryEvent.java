...
public class HandlerRegistryEvent {
    ...
    public void onRegisterItems(RegistryEvent.Register<Item> event) {
        ...
        event.getRegistry().registerAll(
                ...
                ModItems.itemFerrocreteIngot.setUnlocalizedName(Reference.MOD_ID + "." + ItemFerrocreteIngot.BASENAME).setRegistryName(Reference.MOD_ID, ItemFerrocreteIngot.BASENAME),
                ...
                ModItems.itemFerrocreteDust.setUnlocalizedName(Reference.MOD_ID + "." + ItemPulverisedFerrocrete.BASENAME).setRegistryName(Reference.MOD_ID, ItemPulverisedFerrocrete.BASENAME),
