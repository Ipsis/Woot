...
public class HandlerRegistryEvent {
    ...
    public void onRegisterItems(RegistryEvent.Register<Item> event) {
        ...
        event.getRegistry().registerAll(
                ...
                ModItems.itemFerrocreteDust.setUnlocalizedName(Reference.MOD_ID + "." + ItemFerrocreteDust.BASENAME).setRegistryName(Reference.MOD_ID, ItemFerrocreteDust.BASENAME),
