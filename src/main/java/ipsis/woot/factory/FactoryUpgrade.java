...
public enum FactoryUpgrade {
    ...
    public static final EnumSet<FactoryUpgrade> LEVEL_1_UPGRADES = EnumSet.of(EFFICIENCY_1, LOOTING_1, MASS_1, RATE_1, XP_1);
    public static final EnumSet<FactoryUpgrade> LEVEL_2_UPGRADES = EnumSet.of(EFFICIENCY_2, LOOTING_2, MASS_2, RATE_2, XP_2);
    public static final EnumSet<FactoryUpgrade> LEVEL_3_UPGRADES = EnumSet.of(EFFICIENCY_3, LOOTING_3, MASS_3, RATE_3, XP_3);
    ...
    public static FactoryUpgrade getUpgrade(FactoryUpgradeType type, int level) {
        ...
        if (type == FactoryUpgradeType.EFFICIENCY) {
