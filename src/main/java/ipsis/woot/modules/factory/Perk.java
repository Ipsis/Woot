...
public enum Perk implements IStringSerializable {
    ...
    public TranslationTextComponent getTooltip() {
        if (EFFICIENCY_PERKS.contains(this))
            return StringHelper.translate("info.woot.perk.efficiency");
        if (LOOTING_PERKS.contains(this))
            return StringHelper.translate("info.woot.perk.looting");
        if (MASS_PERKS.contains(this))
            return StringHelper.translate("info.woot.perk.mass");
        if (RATE_PERKS.contains(this))
            return StringHelper.translate("info.woot.perk.rate");
        if (TIER_SHARD_PERKS.contains(this))
            return StringHelper.translate("info.woot.perk.tier_shard");
        if (XP_PERKS.contains(this))
            return StringHelper.translate("info.woot.perk.xp");
        if (HEADLESS_PERKS.contains(this))
            return StringHelper.translate("info.woot.perk.headless");
    ...
    public List<TranslationTextComponent> getTooltipForLevel() {
        ...
        if (EFFICIENCY_PERKS.contains(this) && getLevel(this) == 1)
             tooltips.add(StringHelper.translate("info.woot.perk.efficiency.0", FactoryConfiguration.EFFICIENCY_1.get()));
        else if (EFFICIENCY_PERKS.contains(this) && getLevel(this) == 2)
            tooltips.add(StringHelper.translate("info.woot.perk.efficiency.0", FactoryConfiguration.EFFICIENCY_2.get()));
        else if (EFFICIENCY_PERKS.contains(this) && getLevel(this) == 3)
            tooltips.add(StringHelper.translate("info.woot.perk.efficiency.0", FactoryConfiguration.EFFICIENCY_3.get()));
        else if (MASS_PERKS.contains(this) && getLevel(this) == 1)
            tooltips.add(StringHelper.translate("info.woot.perk.mass.0", FactoryConfiguration.MASS_COUNT_1.get()));
        else if (MASS_PERKS.contains(this) && getLevel(this) == 2)
            tooltips.add(StringHelper.translate("info.woot.perk.mass.0", FactoryConfiguration.MASS_COUNT_2.get()));
        else if (MASS_PERKS.contains(this) && getLevel(this) == 3)
            tooltips.add(StringHelper.translate("info.woot.perk.mass.0", FactoryConfiguration.MASS_COUNT_3.get()));
        else if (RATE_PERKS.contains(this) && getLevel(this) == 1)
            tooltips.add(StringHelper.translate("info.woot.perk.rate.0", FactoryConfiguration.RATE_1.get()));
        else if (RATE_PERKS.contains(this) && getLevel(this) == 2)
            tooltips.add(StringHelper.translate("info.woot.perk.rate.0", FactoryConfiguration.RATE_2.get()));
        else if (RATE_PERKS.contains(this) && getLevel(this) == 3)
            tooltips.add(StringHelper.translate("info.woot.perk.rate.0", FactoryConfiguration.RATE_3.get()));
        else if (TIER_SHARD_PERKS.contains(this) && getLevel(this) == 1)
            tooltips.add(StringHelper.translate("info.woot.perk.tier_shard.0", FactoryConfiguration.TIER_SHARD_1.get()));
        else if (TIER_SHARD_PERKS.contains(this) && getLevel(this) == 2)
            tooltips.add(StringHelper.translate("info.woot.perk.tier_shard.0", FactoryConfiguration.TIER_SHARD_2.get()));
        else if (TIER_SHARD_PERKS.contains(this) && getLevel(this) == 3)
            tooltips.add(StringHelper.translate("info.woot.perk.tier_shard.0", FactoryConfiguration.TIER_SHARD_3.get()));
        else if (XP_PERKS.contains(this) && getLevel(this) == 1)
            tooltips.add(StringHelper.translate("info.woot.perk.xp.0", FactoryConfiguration.XP_1.get()));
        else if (XP_PERKS.contains(this) && getLevel(this) == 2)
            tooltips.add(StringHelper.translate("info.woot.perk.xp.0", FactoryConfiguration.XP_2.get()));
        else if (XP_PERKS.contains(this) && getLevel(this) == 3)
            tooltips.add(StringHelper.translate("info.woot.perk.xp.0", FactoryConfiguration.XP_3.get()));
        else if (HEADLESS_PERKS.contains(this) && getLevel(this) == 1)
            tooltips.add(StringHelper.translate("info.woot.perk.headless.0", FactoryConfiguration.HEADLESS_1.get()));
        else if (HEADLESS_PERKS.contains(this) && getLevel(this) == 2)
            tooltips.add(StringHelper.translate("info.woot.perk.headless.0", FactoryConfiguration.HEADLESS_2.get()));
        else if (HEADLESS_PERKS.contains(this) && getLevel(this) == 3)
            tooltips.add(StringHelper.translate("info.woot.perk.headless.0", FactoryConfiguration.HEADLESS_3.get()));
