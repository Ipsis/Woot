...
public enum EnumConfigKey {
    ...
    LOOTING_1_PARAM("looting1Param", Integer.class, 1, true),
    LOOTING_2_PARAM("looting2Param", Integer.class, 2, true),
    LOOTING_3_PARAM("looting3Param", Integer.class, 3, true),
