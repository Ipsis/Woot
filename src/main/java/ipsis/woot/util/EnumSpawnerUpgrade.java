...
public enum EnumSpawnerUpgrade implements IStringSerializable {
    ...
    BM_CRYSTAL_I(EnumConfigKey.BM_CRYSTAL_1_POWER_TICK, null, 1),
    BM_CRYSTAL_II(EnumConfigKey.BM_CRYSTAL_2_POWER_TICK, null, 2),
    BM_CRYSTAL_III(EnumConfigKey.BM_CRYSTAL_3_POWER_TICK, null, 3);
