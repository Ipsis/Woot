...
public class FakePlayerPool {
    ...
    static GameProfile WOOT_GAME_PROFILE_I = new GameProfile(UUID.nameUUIDFromBytes("[Woot_I]".getBytes()), "[Woot]");
    static GameProfile WOOT_GAME_PROFILE_II = new GameProfile(UUID.nameUUIDFromBytes("[Woot_II]".getBytes()), "[Woot]");
    static GameProfile WOOT_GAME_PROFILE_III = new GameProfile(UUID.nameUUIDFromBytes("[Woot_III]".getBytes()), "[Woot]");
